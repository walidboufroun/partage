...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="/public/" data-template="vertical-menu-template-free">
...
<body>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="ajouter_file" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Ajouter Fichiers</div>
                        </a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="users_create   " class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Ajouter Utilisateurs</div>
                        </a>
                    </li>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <a class="github-button"
                                    ...
                                    aria-label="Star themeselection/sneat-html-admin-template-free on GitHub">Walid
                                    Boufroune</a>
                            </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="img/ae.jpeg" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">Walid BOUFROUNE</span>
                        ...
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                <a href="https://themeselection.com" target="_blank"
                                    class="footer-link fw-bolder">BOUFROUNE Walid</a>
                            </div>
                            <div>
    ...
    <div class="buy-now">
        <a href="/ajouter_file"      class="btn btn-primary btn-buy-now">Ajouter Fichier</a>
    </div>
